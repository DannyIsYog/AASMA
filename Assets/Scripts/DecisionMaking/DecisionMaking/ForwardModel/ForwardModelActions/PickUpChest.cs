...
namespace Assets.Scripts.IAJ.Unity.DecisionMaking.ForwardModel.ForwardModelActions
{
    public class PickUpChest : WalkToTargetAndExecuteAction
    {
        ...
        public override float GetGoalChange(Goal goal)
        {
            ...
            if (goal.Name == AutonomousCharacter.GET_RICH_GOAL) change -= 2.0f;
            return change;
        }
        ...
        public override void ApplyActionEffects(WorldModel worldModel)
        {
            ...
            worldModel.SetGoalValue(AutonomousCharacter.GET_RICH_GOAL, goalValue - 2.0f);
        ...
        public override float GetHValue(WorldModel worldModel)
        {
            ...
            // Increase heuristic the more gold you have, as it helps to finish the game
            return value - (float)worldModel.GetProperty(Properties.MONEY) * 0.5f;
        }
    }
}
