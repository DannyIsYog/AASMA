...
namespace Assets.Scripts.Agent
{
    public class PersonControl : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            //TODO bug
            this.Actions.Add(new Assets.Scripts.Algporithm.DecisionMaking.Actions.UseMask(this));

            //quarantine in a building maybe?
             foreach (var quarantineCenter in GameObject.FindGameObjectsWithTag("QuarantineCenter"))
                this.Actions.Add(new Test(this, quarantineCenter));
            ...
            var worldModel = new CurrentStateWorldModel(personData, GameManager, this.Actions, this.Goals);
